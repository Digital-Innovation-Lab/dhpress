...
// NOTES: Minor modifications by Michael Newton, UNC Digital Innovation Lab, to support
//  (1) multiple values on each dimension,
//  (2) output of selection in marker-list DIV
...
(function() {
	d3.parsets = function() {
		var event = d3.dispatch("sortDimensions", "sortCategories"),
				...
				labelAlpha = dhpServices.getText('#dhp-script-flow-alpha'),
				labelSize = dhpServices.getText('#dhp-script-flow-size'),
